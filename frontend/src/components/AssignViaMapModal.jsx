...
export default function AssignViaMapModal({
  isOpen,
  onClose,
  sos,
  onAssigned,
  ...
  const getResponderDistance = useCallback(
    (responderId) => {
      return distances[responderId] !== undefined
        ? formatDistance(distances[responderId])
        : "Calculating...";
    },
    [distances]
  );
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex-shrink-0 flex items-center justify-between p-6 border-b border-slate-200 bg-gradient-to-r from-slate-50 to-white rounded-t-2xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm mt-1">
                {getEmergencyIcon(sos.emergency)} {sos.emergency} Emergency •{" "}
                {sos.name}
              </p>
            </div>
          </div>
          ...
          >
            <span className="text-xl text-slate-500 group-hover:text-slate-700 transition-colors">
              ✕
            </span>
          </button>
        </div>
                      ...
                      <div className="p-3 min-w-[200px]">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-600">
                              {selectedResponder.responderType}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-2 mb-4">
                          <div className="flex justify-between items-center">
                            ...
                            <span
                              className={`text-sm font-semibold ${getStatusColor(selectedResponder.status)}`}
                            >
                          ...
                          <div className="flex justify-between items-center">
                            ...
                            <span
                              className={`text-sm font-medium ${getDistanceColor(distances[selectedResponder._id] || 0)}`}
                            >
                ...
                <h3 className="font-semibold text-slate-800 mb-3 flex items-center gap-2">
                  ...
                  {closestResponder && (
                    <span className="text-sm text-green-600 font-normal ml-2">
                      • Closest: {closestResponder.name} (
                      {getResponderDistance(closestResponder._id)})
                    </span>
                  )}
                </h3>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          ...
                          <p
                            className={`text-xs font-medium ${getDistanceColor(distances[responder._id] || 0)}`}
                          >
            ...
            {responders.length === 0 && !isLoading && (
              <div className="text-center py-8">
                ...
                <p className="text-slate-600">
                  No available responders for this emergency type in your area.
                </p>
              </div>
            )}
          </div>
